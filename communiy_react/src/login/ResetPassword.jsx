...
export default function ResetPassword() {
  ...
  const oldPassNotEmpty = () => {
    if (oldPassValue.current !== null) {
      setIsOldPassChecked(true);
    } else {
      setIsOldPassChecked(false);
    }
  };
  ...
  const patterns = {
    ...
    repass: (value) => value === formData.newPass,
  };
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (!oldPassChecked) {
      alert('이전 비밀번호를 입력 바랍니다.');
      oldPassValue.current.focus();
