              ...
              <Form>
                ...
                >
                  ...
                  <Form.Control
                    ...
                    ref={g_title}
                    value="모임"
                    onChange={(e) => setG_title(e.target.value)}
                  />
                ...
                <div className="d-flex  justify-content-between align-items-end">
                  <div className="register_button">
                    ...
                    <input
                      type="file"
                      className="mb-3"
                      defaultValue={img_url1}
                      onChange={(e) => setImg1_url(e.target.value)}
                    />
                    <p>모임 상세 이미지 등록</p>
                    <input
                      type="file"
                      defaultValue={img_url2}
                      onChange={(e) => setImg2_url(e.target.value)}
                    />
                    <input
                      type="file"
                      defaultValue={img_url3}
                      onChange={(e) => setImg3_url(e.target.value)}
                    />
                  </div>
                  <div>
                    <Button
